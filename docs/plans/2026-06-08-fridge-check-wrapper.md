---
title: Fridge Check Wrapper
type: chore
status: completed
date: 2026-06-08
---

# Fridge Check Wrapper

## Summary

Expose the Fridge tablet app's SDK-free source check and SDK-backed Gradle
gates through the shared root `make check` command.
